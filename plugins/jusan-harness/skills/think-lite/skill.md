...
description: |
  ...
  NOT for: maximum depth analysis or important design decisions (use /think-full).
...
> think- 패밀리의 **일상용**. 깊이가 필요하면 `/think-full` 사용.
...
최종 Stage 완료 시 `${CLAUDE_PLUGIN_ROOT}/skills/_core/protocols.md`의 인사이트 체크포인트를 실행:
- 적응형 사고 과정에서 발견된 인사이트가 있는가?
- 해당 시 `/insight-check` 호출하여 기록 제안

## 참조

- Cynefin: `${CLAUDE_PLUGIN_ROOT}/skills/cynefin/skill.md`
- What: `${CLAUDE_PLUGIN_ROOT}/skills/what/skill.md`
- First Principles: `${CLAUDE_PLUGIN_ROOT}/skills/first-principles/skill.md`
- CE Advisor: `${CLAUDE_PLUGIN_ROOT}/skills/ce-advisor/skill.md`
- Deep Analysis: `${CLAUDE_PLUGIN_ROOT}/skills/deep-analysis-mode/skill.md`
- OODA: `${CLAUDE_PLUGIN_ROOT}/skills/ooda/skill.md`
