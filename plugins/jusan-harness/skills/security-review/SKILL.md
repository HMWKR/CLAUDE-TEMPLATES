...
> **공통**: `~/.claude/skills/_core/protocols.md` + `~/.claude/skills/_core/roles.md`
...
- `~/.claude/agents/security-reviewer.md` (단축형 PR 보안 검토 agent)
- `~/.claude/skills/security-audit/SKILL.md` (전수 OWASP 감사 3 specialists)
- `~/.claude/skills/frontend-review/SKILL.md` (Tier 6 FE 보안)
- `~/.claude/skills/_core/protocols.md`
